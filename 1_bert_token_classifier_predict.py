...
if __name__ == "__main__":
    """
    RUN EXAMPLE:
        python3 1_bert_token_classifier_predict.py -m saved_models/BERT_ABBR_876972 --bert_model 'EMBEDDIA/sloberta' \
            --epoch 5 --test_path data/sbl-51abbr.tok.test.json --gold_labels True
    """
